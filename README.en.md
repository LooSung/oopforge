...
>
> An OOP/DDD methodology pack that injects clean-architecture discipline into any AI coding agent — Claude Code, Codex CLI, OpenCode, and friends.

[한국어 README](./README.md) · [English](./README.en.md)
...
| **UI Language** | EN | EN, ZH, JA | **KO-first + EN** |

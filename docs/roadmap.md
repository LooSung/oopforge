...
## Done — v0.2.2 (proof gap)

README/스킬 4종 스택 ↔ runnable examples **신뢰 갭** 해소. Released **v0.2.2**.

- [x] `examples/order-java-layered/` — Spring 3-tier, same place-order, `./gradlew test`
- [x] `examples/order-python-layered/` — FastAPI 3-tier, same place-order, `pytest`
...
- `examples/order-python` + `order-python-layered` — FastAPI clean + FastAPI layered runnable proof

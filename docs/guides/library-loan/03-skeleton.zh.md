...
- Java: `{pack}/skills/lang/java/spring-hexagonal-layout.md` → 命令: `/oopforge:skeleton java-spring`
- Python: `{pack}/skills/lang/python/clean-fastapi-layout.md` → 命令: `/oopforge:skeleton python-fastapi`

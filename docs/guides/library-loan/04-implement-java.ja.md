...
Domain → application → adapter の順。**Domain layer: Spring import 0.**
...
**`LoanRepository.java`** — アウトバウンド port
```java
...
次: [05-test.ja.md](./05-test.ja.md) · Python: [04-implement-python.ja.md](./04-implement-python.ja.md)

...
Domain tests run **without** Spring or DB fixtures. Use case tests use in-memory ports.

---

## Java (JUnit 5)

### Domain — no Spring context needed
...
Next: [06-layer-rules.md](./06-layer-rules.md)

...
Domain → application → adapter 顺序。**Domain layer: Spring import 0.**
...
下一步: [05-test.zh.md](./05-test.zh.md) · Python: [04-implement-python.zh.md](./04-implement-python.zh.md)

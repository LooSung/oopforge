...
## 체크리스트
- [ ] 대상 스택 선택 (아래 표 참조)
- [ ] `skills/lang/backend-layout.md`를 먼저 읽음
...
Skeleton은 직접 레이아웃을 발명하지 않는다. `skills/lang/backend-layout.md`를 따른다.

| Stack | Layout source | 언제 |
|---|---|---|
| `java-spring-layered` | `skills/lang/backend-layout.md` | 3계층 (Controller/Service/Repository), 작은 서비스/MVP |
| `java-spring-hexagonal` | `skills/lang/backend-layout.md` | 헥사고날, 도메인 복잡 |
| `python-fastapi-layered` | `skills/lang/backend-layout.md` | 3계층 (Router/Service/Repository), 작은 서비스/MVP |
| `python-fastapi-clean` | `skills/lang/backend-layout.md` | FastAPI clean, 도메인 복잡 |
...
- **백엔드 레이아웃 무시 금지** — Java/Python 기본 구조는 `skills/lang/backend-layout.md`를 우선한다.
